export const VACANCY = [
  ...
  {
    title: 'Mixed Reality Developer (Unity)',
    number: '02',
    intro: '',
    ...
    responsibilities2: ['Integrate with AR/VR hardware', 'Optimize user experience'],
    requirements1: ['Strong experience with Unity 3D', 'Proficiency in C#'],
    requirements2: ['Familiarity with AR/VR development', 'Portfolio of relevant projects'],
  },
  {
    ...
    responsibilities1: [
      'Maintain cloud and on-premise infrastructure',
      'Implement CI/CD pipelines ',
    ],
    responsibilities2: ['Optimize data pipelines', 'Ensure system security'],
    requirements1: [
      'Experience with cloud services (AWS, Azure, GCP)',
      'Knowledge of containerization (Docker, Kubernetes)',
    ],
    requirements2: ['Familiarity with CI/CD tools', 'Strong problem-solving skills'],
  },
]
