  ...
  return (
    <div style={{ backgroundColor: '#1A1A1A', color: '#ffffff', height: '100vh' }}>
      ...
      >
        ...
        <h2 style={{ color: '#ffffff', fontSize: '2rem' }} id="effective-date-october-24-2023">
        ...
        <h2 style={{ color: '#ffffff', fontSize: '2rem' }} id="information-we-collect">
        ...
        <h2 style={{ color: '#ffffff', fontSize: '2rem' }} id="how-we-use-information">
        ...
        <h2 style={{ color: '#ffffff', fontSize: '2rem' }} id="sharing-of-information">
        ...
        <h2 style={{ color: '#ffffff', fontSize: '2rem' }} id="security">
          Security
        </h2>
        <p>
        ...
        <h2 style={{ color: '#ffffff', fontSize: '2rem' }} id="changes-to-privacy-policy">
